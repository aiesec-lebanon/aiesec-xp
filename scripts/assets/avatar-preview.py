# Renders the shipped .glb files, once at their default colours and once
# recoloured, so a rebuild can be checked without opening the app.
#
...
def main():
    ...
    recolour()
    render(os.path.join(out_dir, "avatars-recoloured.png"))
